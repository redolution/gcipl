 ...
 * application code, as the configuration descriptor contains several sub-descriptors which vary
 * between devices, and which describe the device's usage to the host.
 */
typedef struct
{
